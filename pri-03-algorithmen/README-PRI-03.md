...
> [Live-Demo](./liveCoding/capitalise-for-forEach-map.md)
...
---
!!! hier will ich ein beispiel aufbauen (for loop), effizienter machen und so auf .sort() auskommen
...
- [Wikipedia Tabelle](https://en.wikipedia.org/wiki/Sorting_algorithm#Comparison_of_algorithms)  
  *LEHRER: Scroll durch, zeige Umfang*
