...
```
✅ Anagramme: Object vs Map vs CustomClass
✅ for...in (Objekte/Keys) vs for...of (Iterable/Werte)
✅ GameCharacter-Klasse (Live-Demo ready)

⏳ Update Notizen: Tabelle Object vs Map
⏳ Teste GameCharacter im Unterricht
⏳ Gaming-Vorlagen sichten
```

## Fertige Unterrichts-Tabelle (Markdown)


| Konzept | Syntax | Iteriert über | Beispiel |
|---------|--------|---------------|----------|
| **for...in** | `for (let key in obj)` | **Keys** | `{a:1}` → `'a'` |
| **for...of** | `for (let val of arr)` | **Werte** | `['a']` → `'a'` |
| **Object** | `obj[char]++` | Strings | Anagram-Counter |
